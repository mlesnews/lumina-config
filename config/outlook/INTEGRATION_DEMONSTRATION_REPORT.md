...
│   (Company Email Hub)       │ - Server: 10.17.17.32
│                             │ - Domain: homelab.lesnewski.local
│   mlesn@                    │ - Account: mlesn@homelab.lesnewski.local
│   homelab.lesnewski.local    │ - IMAP: 993 (SSL/TLS)
│                             │ - SMTP: 587 (STARTTLS)
│   [Unified Email Storage]   │ - Webmail: https://10.17.17.32:5001/mailplus
...
└──────────────┬──────────────┘
       ...
       │  [Unified     │ - Server: 10.17.17.32:993
...
3. Add account: mlesn@homelab.lesnewski.local
...
2. **Configure Outlook Classic:**
   ...
   - Add account: mlesn@homelab.lesnewski.local
...
- Company email (homelab.lesnewski.local) integrated
