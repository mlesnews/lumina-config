...
- You can send from: `mlesn@homelab.lesnewski.local`
...
- Verify NAS MailPlus is running: https://10.17.17.32:5001/mailplus
- Check network connectivity to 10.17.17.32
