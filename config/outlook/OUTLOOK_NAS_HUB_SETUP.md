...
2. **NAS Mail Hub** configured and running (10.17.17.32)
3. **Gmail and ProtonMail** emails being imported to NAS Mail Hub
4. **Company email account** on NAS Mail Hub (mlesn@homelab.lesnewski.local)
...
1. Open web browser
2. Navigate to: https://10.17.17.32:5001/mailplus
...
- **Issue**: "Cannot connect to server"
  ...
  - **Solution**: Check network connectivity to 10.17.17.32
  - **Solution**: Verify firewall allows connections on ports 993 (IMAP) and 587 (SMTP)

### Authentication Fails
- **Issue**: "Username and password not accepted"
  - **Solution**: Verify username is: mlesn@homelab.lesnewski.local
